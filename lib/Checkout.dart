...
class _SignupPageState extends State<Checkout> {
  @override
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Align(
              alignment: Alignment.centerLeft,
              child: Text('PayU Money - This page will redirect to PayU Money, do not refresh the page while on the payment or after the payment page.',
